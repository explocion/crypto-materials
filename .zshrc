...
# Replace ls with eza
alias ls='eza --color=always --group-directories-first --icons=automatic' # preferred listing
alias la='eza -a --color=always --group-directories-first --icons=automatic'  # all files and dirs
alias ll='eza -l --color=always --group-directories-first --icons=automatic'  # long format
alias lt='eza -aT --color=always --group-directories-first --icons=automatic' # tree listing
alias l.='eza -ald --color=always --group-directories-first --icons=automatic .*' # show only dotfiles
